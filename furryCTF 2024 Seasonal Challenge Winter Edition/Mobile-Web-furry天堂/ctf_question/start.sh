...
if [ -e "/bootstrap/first_run" ]; then
	rm /bootstrap/first_run
	mysql -u root < /ctf_question.sql
	mysqladmin -u root password "PMkrcMsxfpL2nRpE"
	rm /ctf_question.sql
fi

echo "Starting apache..."
# cp /etc/apache2/httpd.conf /apache2/
httpd -D FOREGROUND