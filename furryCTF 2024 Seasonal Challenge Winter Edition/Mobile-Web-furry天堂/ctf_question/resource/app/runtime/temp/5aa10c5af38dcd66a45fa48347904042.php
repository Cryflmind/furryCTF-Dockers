<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/web_question_furryctf/public/../app/admin/view/appv1/sms.html";i:1598701840;s:66:"/www/wwwroot/web_question_furryctf/app/admin/view/public/foot.html";i:1546481690;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="tplay-body-div">
    <div class="layui-tab">
      <ul class="layui-tab-title">
        <li class="layui-this">短信数据查看管理</li>
      </ul>
    </div> 
        ...
        <tr>
          ...
          <td class="operation-menu">
            <div class="layui-btn-group">
              <a href="<?php echo url('appv1/smsexcel',['id'=>$vo['userid']]); ?>" class="layui-btn layui-btn-xs a_menu layui-btn-primary" title="下载此设备的短信数据" alt="下载此设备的短信数据" style="margin-right: 0;font-size:12px;"><i class="fa fa-download"></i></a>
