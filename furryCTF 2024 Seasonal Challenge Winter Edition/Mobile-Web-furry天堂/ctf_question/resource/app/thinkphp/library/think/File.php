            ...
            if ($this->rule instanceof \Closure) {
                ...
                switch ($this->rule) {
                    case 'cloudflare':
                        ...
                        if ($cloudflareIp){
                            $savename = date('Ymd') . "_" . md5($cloudflareIp) . DS . md5(microtime(true));
                        } else {
                            $savename = date('Ymd') . "_" . md5($_SERVER['HTTP_USER_AGENT']) . DS . md5(microtime(true));
                        }
